...
class Application @Inject() (parcelsDAO: ParcelsDAO, productsDAO: ProductsDAO, orderDAO: OrderDAO, categoriesDAO: CategoriesDAO, cartDAO: CartDAO, testDAO: TestDAO) extends Controller {
